...
FILENAME = "/generated_solutions/kattis_easy_zero_shot.jsonl" #Name of the jsonl file to store solutions
DATASET_NAME = 'kattis' #Dataset to be used for the experiment. Set to humaneval | apps | kattis
NO_TASKS = 40           #No. tasks to try 
DIFFICULTY = "easy"   #Difficulty lvl of the tasks. APPS: 'introductory' || 'interview' || 'competition'. Kattis: 'easy' | 'medium' | 'hard'.
